...
public class TrangChuTabbed extends JPanel {
    ...
    private static final String IMAGES[] =
            {"logo01.jpg", "logo02.jpg", "logo03.jpg", "R.png", "OIA.png", "OAP.png"};
	...
	private ImagePanel imagePanelTop;
...
//        JLabel lblTitte = new JLabel("Chào Mừng Bạn Đến Với Hệ Thống");
//        pnN.setBackground(MaterialDesign.COLOR_BACKGROUND);
//        lblTitte.setFont(MaterialDesign.FONT_TITLE_1);
//        pnN.add(lblTitte);
        
        JPanel pnC = new JPanel();
        pnC.setSize(new Dimension(1000, 500));
        add(pnC, BorderLayout.CENTER);
        MaterialDesign.materialPanel(pnC);
        pnC.setBackground(MaterialDesign.COLOR_BACKGROUND);
...
//        topPanel = new JPanel();
//        topPanel.setLayout(new BoxLayout(rightPanel, BoxLayout.X_AXIS));
//        MaterialDesign.materialPanel(rightPanel);
//        topPanel.setBackground(MaterialDesign.COLOR_BACKGROUND);
//        this.add(topPanel, BorderLayout.CENTER);
//
//        imagePanelTop = new ImagePanel(generateImagePath());
//        imagePanelTop.setPreferredSize(new Dimension(550, 500));
//        imagePanelTop.setMaximumSize(new Dimension(600, 500));
//        MaterialDesign.materialPanel(imagePanelTop);
//        imagePanelTop.setBackground(MaterialDesign.COLOR_BACKGROUND);
//        boxLoiChao1.add(imagePanelTop);

//        String loiChuc = "Quản lý cho thuê băng đĩa";
...
//
//        imagePanel = new ImagePanel(generateImagePath());
//        imagePanel.setPreferredSize(new Dimension(900, 500));
//        imagePanel.setMaximumSize(new Dimension(1000, 500));
//        MaterialDesign.materialPanel(imagePanel);
//        imagePanel.setBackground(MaterialDesign.COLOR_BACKGROUND);
