...
public class MainForm extends JFrame {
    ...
    private void prepareUI() {
        ...
        // TITLE
        lblTitle = new JLabel("Ứng Dụng Quản Lý Cửa Hàng Cho Thuê Băng Đĩa");
        lblTitle.setHorizontalAlignment(SwingConstants.LEFT);
        lblTitle.setIcon(MaterialDesign.ICON_TC);
        lblTitle.setPreferredSize(new Dimension(900, topPanel.getHeight()));
        ...
        // tabbed panel
        ImageIcon trangChuIcon = new ImageIcon("resources/images/TrangChu.png");
...
//        menuTabbed.setIconAt(0, trangChuIcon);
